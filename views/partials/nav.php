      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <?php echo $_SESSION['user'] ? "<a href='/todos' class='rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Todos</a>" : ""; ?>
            <?php echo !$_SESSION['user'] ? "<a href='/register' class='rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Register</a>" : ''; ?>
            <?php echo !$_SESSION['user'] ? "<a href='/login' class='rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Login</a>" : ''; ?>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
...
<input type="hidden" name="_method" value="DELETE" />
  ...
  <div class="md:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
      ...
      <?php echo $_SESSION['user'] ? "<a href='/todos' class='block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Todos</a>" : ""; ?>
      <?php echo !$_SESSION['user'] ? "<a href='/register' class='block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Register</a>" : ""; ?>
      <?php echo !$_SESSION['user'] ? "<a href='/login' class='block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white'>Login</a>" : ""; ?>
    </div>
    <?php if ($_SESSION['user']) : ?>
